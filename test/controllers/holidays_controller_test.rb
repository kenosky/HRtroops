...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { date: @holiday.date, details: @holiday.details, profile_id: @holiday.profile_id }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { date: @holiday.date, details: @holiday.details, profile_id: @holiday.profile_id }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
